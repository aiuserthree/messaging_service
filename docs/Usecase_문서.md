...
- 회원이 로그인되어 있어야 함
- 회원 계정이 정상 상태여야 함
- 카카오톡 채널(https://center-pf.kakao.com)에서 비즈니스 채널로 등록된 카카오톡 채널(발신프로필)이 iSend에 등록되어 있어야 함
...
### 3.4 Usecase 설명
회원이 카카오톡 채널(발신프로필)을 등록하고 관리하는 프로세스. 카카오톡 채널(https://center-pf.kakao.com)에서 비즈니스 채널로 등록된 카카오톡 채널(발신프로필)만 iSend에 등록 가능
